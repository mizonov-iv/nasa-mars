  ...
  <section class="section rovers-section">
    ...
    <main class="container">
      ...
      <div v-show="!showForm">
        ...
        <button @click="loadMore" v-if="showLoadMoreButton" class="select-btn load-more-btn">Load more</button>
      </div>
